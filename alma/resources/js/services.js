...
myapp.service('AuthSharedService', function ($rootScope, $http, $resource, authService, Session, store, jwtHelper) {
...
myapp.service('HomeService', function ($rootScope, $log, $resource, store, jwtHelper, $http) {
...
myapp.service('UsersService', function ($rootScope, $log, $resource, $http, store, jwtHelper) {
...
myapp.service('TokensService', function ($rootScope, $log, $resource, store, jwtHelper, $http) {
