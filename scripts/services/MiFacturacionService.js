...
app.service('MiFacturacionService', function  ($resource,REST_SERVICE_URI){
    this.getDatos = function (numero){
        var layoutResource = $resource(REST_SERVICE_URI.service + '/public/MiFacturacionService/'+numero).get({});
