...
app.service('MisServiciosService', function  ($resource,REST_SERVICE_URI){
    this.getDatos = function (numero){
        var layoutResource = $resource(REST_SERVICE_URI.service + '/public/MisServiciosService/'+numero).get({});
